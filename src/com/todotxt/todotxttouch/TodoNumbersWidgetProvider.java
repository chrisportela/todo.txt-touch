...
public class TodoNumbersWidgetProvider extends AppWidgetProvider {

	private static final String TAG = TodoNumbersWidgetProvider.class.getName();
	...
	private void updateWidgetContent(Context context,
		...
		if (widgetIds == null) {
			widgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
					context, TodoNumbersWidgetProvider.class.getName()));
		}
